...
const routines = [
  {
    ...
    description: "Gunakan fitur pencari rutinitas kami. Pahami jenis kulit Anda secara instan dan dapatkan rekomendasi produk yang dipersonalisasi.",
  ...
  },
  {
    ...
    description: "Luangkan waktu sejenak di pagi dan malam hari. Biarkan setiap usapan menjadi bentuk penghargaan terhadap diri sendiri.",
    time: "Setiap Hari",
  ...
  },
  {
    ...
    description: "Perhatikan tekstur kulit yang membaik, kelembapan yang kembali seimbang, dan kilau alami yang bersinar dari dalam.",
...
function Routine() {
  ...
  return (
    <section className="bg-[url('/Glowing-Skin-Close-Up.png')] bg-cover bg-center mt-10 md:mt-20">
      <div className="bg-black/60 backdrop-blur-md py-16 md:py-24">
        <div 
          className={cn("p-5 md:p-10 max-w-4xl mx-auto animate-on-scroll", isVisible && "is-visible")}
          ref={ref}
        >
          ...
          <p className="text-base md:text-lg font-normal text-white/80 text-center mt-4">
            Telah dicoba, diuji, dan dicintai oleh ribuan pelanggan. Mulai perjalanan kulit sehat Anda hari ini.
          </p>
        </div>
